// translations_ubytovani.js
export const translations_ubytovani = {
  cs: {
    pageTitle: "Ubytování",
    heroAlt: "Pension U Lidmanů – ubytování",
    heading: "Ubytování v Pensionu U Lidmanů",
    intro:
      "Nabízíme útulné pokoje v rodinném pensionu v srdci Broumovska. Ideální místo pro rodiny, páry i skupiny přátel.",
    ...
    surroundingsTitle: "Okolí",
    surroundingsText:
      "Pension se nachází v malebné obci Machovská Lhota, obklopené krásnou přírodou Broumovských stěn a Stolových hor.",
    reservationCta: "Rezervujte si svůj pobyt ještě dnes",
    openingHours: {
      pension: "Otevírací doba pensionu: denně dle objednávek",
      restaurantTitle: "Otevírací doba restaurace pro ubytované hosty:",
      monThu: "Po - Čt 8:00-9:30 a 18:00-20:00",
      fri: "Pá 8:00-9:30 a 11:30 - 21:00",
      sat: "So 8:00-9:30 a 11:30 - 21:00",
  ...
  en: {
    ...
    heroAlt: "Pension U Lidmanů – accommodation",
    heading: "Accommodation at Pension U Lidmanů",
    intro:
      "We offer cozy rooms in a family-run pension in the heart of Broumovsko. The perfect place for families, couples, and groups of friends.",
    ...
    surroundingsText:
      "The pension is located in the picturesque village of Machovská Lhota, surrounded by the beautiful nature of the Broumov Walls and Table Mountains.",
    reservationCta: "Book your stay today",
    openingHours: {
      pension: "Pension opening hours: daily by reservation",
      restaurantTitle: "Restaurant opening hours for accommodated guests:",
      monThu: "Mon - Thu 8:00-9:30 and 18:00-20:00",
      fri: "Fri 8:00-9:30 and 11:30 - 21:00",
    ...
    tiles: [
      {
        alt: "Dining room",
        text: "In our fireplace dining room with capacity for 40 guests, we serve classic Czech meals and homemade desserts as a daily menu. At the bar you will find Moravian wines, regional beer, soft drinks, alcoholic drinks and hot beverages.",
      },
      {
        alt: "Garden",
        text: "In nice weather, you can sit in our summer garden with the award-winning apple tree, Czech Tree of the Year 2020. Enjoy peaceful countryside views, while children can play in the sandbox or on the swing.",
      },
      {
        alt: "Lounge",
        text: "The restaurant lounge with capacity for 20 guests is suitable for smaller celebrations, training sessions, a social room for accommodated guests, or as an extension of the main dining area.",
      },
      {
        alt: "Hall",
        text: "The large social hall with capacity for 70 guests is intended for bigger events - weddings, celebrations, trainings, lectures, exhibitions, etc.",
      },
    ],
  },

  de: {
    pageTitle: "Unterkunft",
    heroAlt: "Pension U Lidmanů – Unterkunft",
    heading: "Unterkunft in der Pension U Lidmanů",
    intro:
      "Wir bieten gemütliche Zimmer in einer familiengeführten Pension im Herzen des Broumovsko. Der perfekte Ort für Familien, Paare und Freundesgruppen.",
    ...
    surroundingsTitle: "Umgebung",
    surroundingsText:
      "Die Pension befindet sich im malerischen Dorf Machovská Lhota, umgeben von der wunderschönen Natur der Broumovské stěny und des Tafelgebirges.",
    reservationCta: "Buchen Sie noch heute Ihren Aufenthalt",
    openingHours: {
      pension: "Öffnungszeiten der Pension: täglich nach Reservierungen",
      restaurantTitle: "Öffnungszeiten des Restaurants für Hausgäste:",
      monThu: "Mo - Do 8:00-9:30 und 18:00-20:00",
      fri: "Fr 8:00-9:30 und 11:30 - 21:00",
      sat: "Sa 8:00-9:30 und 11:30 - 21:00",
    ...
    tiles: [
      {
        alt: "Gastraum",
        text: "In unserem Gastraum mit Kamin und 40 Sitzplätzen servieren wir klassische tschechische Küche und hausgemachte Desserts als Tagesangebot. An der Bar finden Sie mährische Weine, regionales Bier sowie alkoholische, alkoholfreie und warme Getränke.",
      },
      {
        alt: "Garten",
        text: "Bei schönem Wetter können Sie in unserem Sommergarten mit dem preisgekrönten Apfelbaum, Baum des Jahres 2020 in Tschechien, sitzen. Genießen Sie die ruhige Landschaft und Ausblicke auf die umliegenden Hügel. Kinder können im Sandkasten spielen oder schaukeln.",
      },
      {
        alt: "Salon",
        text: "Der Restaurant-Salon mit 20 Sitzplätzen eignet sich für kleinere Feiern, Schulungen, als Aufenthaltsraum für Hausgäste oder als Erweiterung des Gastraums bei größerer Gästezahl.",
      },
      {
        alt: "Saal",
        text: "Der große Gesellschaftssaal mit 70 Sitzplätzen ist für größere Veranstaltungen gedacht - Hochzeiten, Feiern, Schulungen, Vorträge, Ausstellungen usw.",
      },
    ],
  },
  ...
  pl: {
    pageTitle: "Noclegi",
    heroAlt: "Pensjonat U Lidmanů – noclegi",
    heading: "Noclegi w Pensjonacie U Lidmanů",
    intro:
      "Oferujemy przytulne pokoje w rodzinnym pensjonacie w sercu Broumowszczyzny. Idealne miejsce dla rodzin, par i grup przyjaciół.",
    ...
    surroundingsTitle: "Okolica",
    surroundingsText:
      "Pensjonat znajduje się w malowniczej miejscowości Machovská Lhota, otoczonej piękną przyrodą Gór Stołowych i Broumovskich Ścian.",
    reservationCta: "Zarezerwuj swój pobyt już dziś",
    openingHours: {
      pension: "Godziny otwarcia pensjonatu: codziennie według rezerwacji",
      restaurantTitle: "Godziny otwarcia restauracji dla gości nocujących:",
      monThu: "Pon - Czw 8:00-9:30 oraz 18:00-20:00",
      fri: "Pt 8:00-9:30 oraz 11:30 - 21:00",
    ...
    tiles: [
      {
        ...
        text: "W naszej sali z kominkiem i miejscem dla 40 osób serwujemy klasyczne dania kuchni czeskiej oraz domowe desery w formie codziennej oferty. W barze znajdą Państwo morawskie wina, regionalne piwo oraz napoje bezalkoholowe, alkoholowe i ciepłe.",
      },
      {
        alt: "Ogród",
        text: "Przy ładnej pogodzie można usiąść w naszym letnim ogródku ze zwycięską jabłonią - Drzewem Roku Czech 2020. To idealne miejsce na odpoczynek z widokiem na okoliczne wzgórza, a dzieci mogą bawić się w piaskownicy lub na huśtawce.",
      },
      {
        alt: "Salon",
        text: "Salon restauracji z pojemnością 20 osób służy do organizacji mniejszych uroczystości, szkoleń, jako pokój wspólny dla gości nocujących lub jako rozszerzenie części restauracyjnej przy większej liczbie gości.",
      },
      {
        alt: "Sala",
        text: "Duża sala bankietowa z pojemnością 70 osób jest przeznaczona do organizacji większych wydarzeń - wesel, uroczystości, szkoleń, wykładów, wystaw itp.",
      },
    ],
  },
};
